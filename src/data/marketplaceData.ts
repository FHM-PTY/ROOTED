...
export const vendors: Vendor[] = [
  ...
  },
  {
    ...
    name: "Urban Soul",
    letter: "U",
    tagline: "Pretoria streetwear crafted from garage cuts to capital culture",
    origin: "Pretoria, South Africa",
    city: "Pretoria",
    gender: ["UNISEX", "MEN", "WOMEN"],
    categories: ["outerwear", "workwear", "accessories", "pretoria"],
    priceRange: "R 320 - R 849",
    featured: true,
    color: "#d6a34c",
    coverImage:
      "https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=1600&q=85",
    productCount: 36,
    coordinates: "25.7461° S, 28.1881° E",
    isThrift: false,
    specialty: "420 GSM Boxy Hoodies & Heavyweight Cargo Twill",
    aboutStory:
      "Thabo started Urban Soul in his mother's garage, cutting his first run of ten hoodies for friends at TUT. He wanted streetwear that felt like Pretoria, not a copy of something overseas.",
    establishedYear: "2023",
    dispatchHub: "Pretoria Central Depot (Bob Go Couriers)",
    contactPhone: "+27 71 832 9481",
    instagram: "@urbansoul_pta",
    commissionRate: 0.08,
  },
]
...
export const products: Product[] = [
  ...
  // Urban Soul (ROOTED Flagship Pretoria Brand)
  {
    id: 101,
    title: "Urban Soul 420 GSM Oversized Hoodie",
    brand: "Urban Soul",
    ...
    badge: "BEST SELLER",
    origin: "Pretoria, South Africa",
    fabric: "420 GSM Brushed French Terry Cotton, Double-Lined Hood",
    sizes: ["S", "M", "L", "XL"],
    description:
      "Signature boxy silhouette with dropped shoulders and thick ribbed cuffs. Developed in Pretoria.",
    isNew: true,
    isPretoria: true,
    stock: 92,
    stockPerSize: { S: 18, M: 34, L: 28, XL: 12 },
    status: "active",
  },
  {
    id: 102,
    title: "Urban Soul Heavyweight Twill Cargo Pant",
    brand: "Urban Soul",
    brandSlug: "urban-soul",
    category: "workwear",
    city: "Pretoria",
    ...
    badge: "PRETORIA CUT",
    origin: "Pretoria, South Africa",
    fabric: "Heavyweight 320 GSM Ripstop Cotton Twill, Gusseted Pockets",
    sizes: ["30", "32", "34", "36"],
    description:
      "Structured utility trousers with custom hardware and articulated knee darting.",
    isNew: true,
    isPretoria: true,
    stock: 68,
    stockPerSize: { "30": 14, "32": 26, "34": 20, "36": 8 },
    status: "active",
  },
  {
    id: 103,
    title: "Urban Soul Boxy Capital Heritage Tee",
    brand: "Urban Soul",
    brandSlug: "urban-soul",
    category: "pretoria",
    city: "Pretoria",
    ...
    origin: "Pretoria, South Africa",
    fabric: "260 GSM Combed Ring-Spun Cotton, Blind Hem Stitching",
    sizes: ["S", "M", "L", "XL"],
    description:
      "Relaxed crewneck tee cut with high collar ribbing and garment-dyed wash.",
    isPretoria: true,
    stock: 44,
    stockPerSize: { S: 8, M: 16, L: 14, XL: 6 },
    status: "active",
  },
  {
    id: 104,
    title: "Urban Soul 012 Embroidered Graphic Cap",
    brand: "Urban Soul",
    brandSlug: "urban-soul",
    category: "accessories",
    city: "Pretoria",
    ...
    badge: "LOW STOCK",
    origin: "Pretoria, South Africa",
    fabric: "6-Panel Unstructured Heavy Cotton Chino Twill, Brass Buckle",
    sizes: ["One Size"],
    description:
      "Low profile dad cap with raised embroidery commemorating Pretoria streetwear roots.",
    isPretoria: true,
    stock: 14,
    stockPerSize: { "One Size": 14 },
    status: "active",
  },
]
